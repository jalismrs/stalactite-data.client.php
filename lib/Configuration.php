...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'stalactite-data.client-1.5.0-dev.2';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 1.5.0-dev.2' . PHP_EOL;
        $report .= '    SDK Package Version: 1.5.0-dev' . PHP_EOL;
