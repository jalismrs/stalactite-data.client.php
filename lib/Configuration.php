...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'stalactite-data.client-/fix-cd-prod';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: /fix-cd-prod' . PHP_EOL;
        $report .= '    SDK Package Version: /fix-cd-prod' . PHP_EOL;
