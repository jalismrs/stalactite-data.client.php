 ...
 */
class Permission2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Permission2';
    ...
    public function setScope($scope)
    {
        if ((mb_strlen($scope) > 30)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling Permission2., must be smaller than or equal to 30.');
        }
    ...
    public function setResource($resource)
    {
        if ((mb_strlen($resource) > 30)) {
            throw new \InvalidArgumentException('invalid length for $resource when calling Permission2., must be smaller than or equal to 30.');
        }
    ...
    public function setOperation($operation)
    {
        if ((mb_strlen($operation) > 30)) {
            throw new \InvalidArgumentException('invalid length for $operation when calling Permission2., must be smaller than or equal to 30.');
        }
    ...
    public function setUid($uid)
    {
        ...
        if ((!preg_match("/[a-z0-9]{64}/", $uid))) {
            throw new \InvalidArgumentException("invalid value for $uid when calling Permission2., must conform to the pattern /[a-z0-9]{64}/.");
        }
