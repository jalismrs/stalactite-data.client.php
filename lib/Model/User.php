...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['posts']) && (count($this->container['posts']) > 0)) {
            $invalidProperties[] = "invalid value for 'posts', number of items must be less than or equal to 0.";
        }

        if (!is_null($this->container['posts']) && (count($this->container['posts']) < 1)) {
     ...
     * Gets posts
     *
     * @return \Jalismrs\Stalactite\Client\Data\Model\Post2[]|null
     */
     ...
     * Sets posts
     *
     * @param \Jalismrs\Stalactite\Client\Data\Model\Post2[]|null $posts posts
     *
     * @return self
     */
     ...
     * Sets leads
     *
     * @param \Jalismrs\Stalactite\Client\Data\Model\Post2[]|null $leads leads
     *
     * @return self
     */
