...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 180)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Customer., must be smaller than or equal to 180.');
        }
    ...
    public function setUid($uid)
    {
        ...
        if ((!preg_match("/[a-z0-9]{64}/", $uid))) {
            throw new \InvalidArgumentException("invalid value for $uid when calling Customer., must conform to the pattern /[a-z0-9]{64}/.");
        }
