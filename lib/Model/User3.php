...
class User3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User3';
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 180)) {
            throw new \InvalidArgumentException('invalid length for $email when calling User3., must be smaller than or equal to 180.');
        }
    ...
    public function setLastName($last_name)
    {
        if ((mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling User3., must be smaller than or equal to 100.');
        }
    ...
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling User3., must be smaller than or equal to 100.');
        }
    ...
    public function setUid($uid)
    {
        ...
        if ((!preg_match("/[a-z0-9]{64}/", $uid))) {
            throw new \InvalidArgumentException("invalid value for $uid when calling User3., must conform to the pattern /[a-z0-9]{64}/.");
        }
