...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addUserLeads'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function addUserLeads($uid, $update_user_leads_request, string $contentType = self::contentTypes['addUserLeads'][0])
    {
        $this->addUserLeadsWithHttpInfo($uid, $update_user_leads_request, $contentType);
    }
     ...
     */
    public function addUserLeadsWithHttpInfo($uid, $update_user_leads_request, string $contentType = self::contentTypes['addUserLeads'][0])
    {
        $request = $this->addUserLeadsRequest($uid, $update_user_leads_request, $contentType);
     ...
     */
    public function addUserLeadsAsync($uid, $update_user_leads_request, string $contentType = self::contentTypes['addUserLeads'][0])
    {
        return $this->addUserLeadsAsyncWithHttpInfo($uid, $update_user_leads_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addUserLeadsAsyncWithHttpInfo($uid, $update_user_leads_request, string $contentType = self::contentTypes['addUserLeads'][0])
    {
        $returnType = '';
        $request = $this->addUserLeadsRequest($uid, $update_user_leads_request, $contentType);
     ...
     */
    public function addUserLeadsRequest($uid, $update_user_leads_request, string $contentType = self::contentTypes['addUserLeads'][0])
    {
        ...
        if (isset($update_user_leads_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_user_leads_request));
            } else {
     ...
     *
     * @param  string $uid uid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getUserLeads'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\Post[]|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getUserLeads($uid, string $contentType = self::contentTypes['getUserLeads'][0])
    {
        list($response) = $this->getUserLeadsWithHttpInfo($uid, $contentType);
        return $response;
    }
     ...
     */
    public function getUserLeadsWithHttpInfo($uid, string $contentType = self::contentTypes['getUserLeads'][0])
    {
        $request = $this->getUserLeadsRequest($uid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserLeadsAsync($uid, string $contentType = self::contentTypes['getUserLeads'][0])
    {
        return $this->getUserLeadsAsyncWithHttpInfo($uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserLeadsAsyncWithHttpInfo($uid, string $contentType = self::contentTypes['getUserLeads'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\Post[]';
        $request = $this->getUserLeadsRequest($uid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserLeadsRequest($uid, string $contentType = self::contentTypes['getUserLeads'][0])
    {
     ...
     * @param  string $uid uid (required)
     * @param  \Jalismrs\Stalactite\Client\Data\Model\UpdateUserLeadsRequest $update_user_leads_request update_user_leads_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeUserLeads'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function removeUserLeads($uid, $update_user_leads_request, string $contentType = self::contentTypes['removeUserLeads'][0])
    {
        $this->removeUserLeadsWithHttpInfo($uid, $update_user_leads_request, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeUserLeadsWithHttpInfo($uid, $update_user_leads_request, string $contentType = self::contentTypes['removeUserLeads'][0])
    {
        $request = $this->removeUserLeadsRequest($uid, $update_user_leads_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeUserLeadsAsync($uid, $update_user_leads_request, string $contentType = self::contentTypes['removeUserLeads'][0])
    {
        return $this->removeUserLeadsAsyncWithHttpInfo($uid, $update_user_leads_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeUserLeadsAsyncWithHttpInfo($uid, $update_user_leads_request, string $contentType = self::contentTypes['removeUserLeads'][0])
    {
        $returnType = '';
        $request = $this->removeUserLeadsRequest($uid, $update_user_leads_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeUserLeadsRequest($uid, $update_user_leads_request, string $contentType = self::contentTypes['removeUserLeads'][0])
    {
