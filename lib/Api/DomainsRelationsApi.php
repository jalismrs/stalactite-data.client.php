...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addCustomerRelations'] to see the possible values for this operation
     *
     ...
     */
    public function addCustomerRelations($uid, $add_customer_relations_request, string $contentType = self::contentTypes['addCustomerRelations'][0])
    {
        list($response) = $this->addCustomerRelationsWithHttpInfo($uid, $add_customer_relations_request, $contentType);
        return $response;
    }
     ...
     */
    public function addCustomerRelationsWithHttpInfo($uid, $add_customer_relations_request, string $contentType = self::contentTypes['addCustomerRelations'][0])
    {
        $request = $this->addCustomerRelationsRequest($uid, $add_customer_relations_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation2[]' === '\SplFileObject') {
                        ...
                        if ('\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation2[]' !== 'string') {
     ...
     */
    public function addCustomerRelationsAsync($uid, $add_customer_relations_request, string $contentType = self::contentTypes['addCustomerRelations'][0])
    {
        return $this->addCustomerRelationsAsyncWithHttpInfo($uid, $add_customer_relations_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addCustomerRelationsAsyncWithHttpInfo($uid, $add_customer_relations_request, string $contentType = self::contentTypes['addCustomerRelations'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation2[]';
        $request = $this->addCustomerRelationsRequest($uid, $add_customer_relations_request, $contentType);
     ...
     */
    public function addCustomerRelationsRequest($uid, $add_customer_relations_request, string $contentType = self::contentTypes['addCustomerRelations'][0])
    {
        ...
        if (isset($add_customer_relations_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($add_customer_relations_request));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addUserRelations'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\DomainUserRelation2[]|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function addUserRelations($uid, $add_user_relations_request, string $contentType = self::contentTypes['addUserRelations'][0])
    {
        list($response) = $this->addUserRelationsWithHttpInfo($uid, $add_user_relations_request, $contentType);
        return $response;
    }
     ...
     */
    public function addUserRelationsWithHttpInfo($uid, $add_user_relations_request, string $contentType = self::contentTypes['addUserRelations'][0])
    {
        $request = $this->addUserRelationsRequest($uid, $add_user_relations_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Jalismrs\Stalactite\Client\Data\Model\DomainUserRelation2[]' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Jalismrs\Stalactite\Client\Data\Model\DomainUserRelation2[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addUserRelationsAsync($uid, $add_user_relations_request, string $contentType = self::contentTypes['addUserRelations'][0])
    {
        return $this->addUserRelationsAsyncWithHttpInfo($uid, $add_user_relations_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addUserRelationsAsyncWithHttpInfo($uid, $add_user_relations_request, string $contentType = self::contentTypes['addUserRelations'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\DomainUserRelation2[]';
        $request = $this->addUserRelationsRequest($uid, $add_user_relations_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function addUserRelationsRequest($uid, $add_user_relations_request, string $contentType = self::contentTypes['addUserRelations'][0])
    {
        ...
        if (isset($add_user_relations_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($add_user_relations_request));
            } else {
     ...
     *
     * @param  string $uid The uid of the domain (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDomainRelations'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\GetDomainRelationsResponse|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getDomainRelations($uid, string $contentType = self::contentTypes['getDomainRelations'][0])
    {
        list($response) = $this->getDomainRelationsWithHttpInfo($uid, $contentType);
        return $response;
    }
     ...
     */
    public function getDomainRelationsWithHttpInfo($uid, string $contentType = self::contentTypes['getDomainRelations'][0])
    {
        $request = $this->getDomainRelationsRequest($uid, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Jalismrs\Stalactite\Client\Data\Model\GetDomainRelationsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Jalismrs\Stalactite\Client\Data\Model\GetDomainRelationsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainRelationsAsync($uid, string $contentType = self::contentTypes['getDomainRelations'][0])
    {
        return $this->getDomainRelationsAsyncWithHttpInfo($uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainRelationsAsyncWithHttpInfo($uid, string $contentType = self::contentTypes['getDomainRelations'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\GetDomainRelationsResponse';
        $request = $this->getDomainRelationsRequest($uid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDomainRelationsRequest($uid, string $contentType = self::contentTypes['getDomainRelations'][0])
    {
