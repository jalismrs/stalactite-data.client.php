...
class CustomersApi
{
     ...
     * @param  int $fullname Filters customers by fullname (optional)
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\GetCustomersResponse|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getCustomers($page = null, $fullname = null)
    {
        list($response) = $this->getCustomersWithHttpInfo($page, $fullname);
        return $response;
    }
     ...
     */
    public function getCustomersWithHttpInfo($page = null, $fullname = null)
    {
        $request = $this->getCustomersRequest($page, $fullname);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomersAsync($page = null, $fullname = null)
    {
        return $this->getCustomersAsyncWithHttpInfo($page, $fullname)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomersAsyncWithHttpInfo($page = null, $fullname = null)
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\GetCustomersResponse';
        $request = $this->getCustomersRequest($page, $fullname);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomersRequest($page = null, $fullname = null)
    {
     ...
     * @return \Jalismrs\Stalactite\Client\Data\Model\Customer|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getMyCustomerInfos()
    {
        list($response) = $this->getMyCustomerInfosWithHttpInfo();
        return $response;
    }

    /**
     * Operation getMyCustomerInfosWithHttpInfo
     *
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jalismrs\Stalactite\Client\Data\Model\Customer|\Jalismrs\Stalactite\Client\Data\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyCustomerInfosWithHttpInfo()
    {
        $request = $this->getMyCustomerInfosRequest();
    ...
    /**
     * Operation getMyCustomerInfosAsync
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCustomerInfosAsync()
    {
        return $this->getMyCustomerInfosAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyCustomerInfosAsyncWithHttpInfo
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCustomerInfosAsyncWithHttpInfo()
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\Customer';
        $request = $this->getMyCustomerInfosRequest();
    ...
    /**
     * Create request for operation 'getMyCustomerInfos'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMyCustomerInfosRequest()
    {
