...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCustomerAccessClearance'] to see the possible values for this operation
     *
     ...
     */
    public function getCustomerAccessClearance($customer_uid, $domain_uid, string $contentType = self::contentTypes['getCustomerAccessClearance'][0])
    {
        list($response) = $this->getCustomerAccessClearanceWithHttpInfo($customer_uid, $domain_uid, $contentType);
        return $response;
    }
     ...
     */
    public function getCustomerAccessClearanceWithHttpInfo($customer_uid, $domain_uid, string $contentType = self::contentTypes['getCustomerAccessClearance'][0])
    {
        $request = $this->getCustomerAccessClearanceRequest($customer_uid, $domain_uid, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Jalismrs\Stalactite\Client\Data\Model\AccessClearance' === '\SplFileObject') {
                        ...
                        if ('\Jalismrs\Stalactite\Client\Data\Model\AccessClearance' !== 'string') {
     ...
     */
    public function getCustomerAccessClearanceAsync($customer_uid, $domain_uid, string $contentType = self::contentTypes['getCustomerAccessClearance'][0])
    {
        return $this->getCustomerAccessClearanceAsyncWithHttpInfo($customer_uid, $domain_uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerAccessClearanceAsyncWithHttpInfo($customer_uid, $domain_uid, string $contentType = self::contentTypes['getCustomerAccessClearance'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\AccessClearance';
        $request = $this->getCustomerAccessClearanceRequest($customer_uid, $domain_uid, $contentType);
     ...
     */
    public function getCustomerAccessClearanceRequest($customer_uid, $domain_uid, string $contentType = self::contentTypes['getCustomerAccessClearance'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMyCustomerAccessClearance'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\AccessClearance|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getMyCustomerAccessClearance($uid, string $contentType = self::contentTypes['getMyCustomerAccessClearance'][0])
    {
        list($response) = $this->getMyCustomerAccessClearanceWithHttpInfo($uid, $contentType);
        return $response;
    }
     ...
     * @return array of \Jalismrs\Stalactite\Client\Data\Model\AccessClearance|\Jalismrs\Stalactite\Client\Data\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyCustomerAccessClearanceWithHttpInfo($uid, string $contentType = self::contentTypes['getMyCustomerAccessClearance'][0])
    {
        $request = $this->getMyCustomerAccessClearanceRequest($uid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCustomerAccessClearanceAsync($uid, string $contentType = self::contentTypes['getMyCustomerAccessClearance'][0])
    {
        return $this->getMyCustomerAccessClearanceAsyncWithHttpInfo($uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCustomerAccessClearanceAsyncWithHttpInfo($uid, string $contentType = self::contentTypes['getMyCustomerAccessClearance'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\AccessClearance';
        $request = $this->getMyCustomerAccessClearanceRequest($uid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMyCustomerAccessClearanceRequest($uid, string $contentType = self::contentTypes['getMyCustomerAccessClearance'][0])
    {
