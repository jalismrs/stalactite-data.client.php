...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCustomerRelations'] to see the possible values for this operation
     *
     ...
     */
    public function getCustomerRelations($uid, string $contentType = self::contentTypes['getCustomerRelations'][0])
    {
        list($response) = $this->getCustomerRelationsWithHttpInfo($uid, $contentType);
        return $response;
    }
     ...
     */
    public function getCustomerRelationsWithHttpInfo($uid, string $contentType = self::contentTypes['getCustomerRelations'][0])
    {
        $request = $this->getCustomerRelationsRequest($uid, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation[]' === '\SplFileObject') {
                        ...
                        if ('\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation[]' !== 'string') {
     ...
     */
    public function getCustomerRelationsAsync($uid, string $contentType = self::contentTypes['getCustomerRelations'][0])
    {
        return $this->getCustomerRelationsAsyncWithHttpInfo($uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerRelationsAsyncWithHttpInfo($uid, string $contentType = self::contentTypes['getCustomerRelations'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation[]';
        $request = $this->getCustomerRelationsRequest($uid, $contentType);
     ...
     */
    public function getCustomerRelationsRequest($uid, string $contentType = self::contentTypes['getCustomerRelations'][0])
    {
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMyCustomerRelations'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation[]|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getMyCustomerRelations(string $contentType = self::contentTypes['getMyCustomerRelations'][0])
    {
        list($response) = $this->getMyCustomerRelationsWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @return array of \Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation[]|\Jalismrs\Stalactite\Client\Data\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyCustomerRelationsWithHttpInfo(string $contentType = self::contentTypes['getMyCustomerRelations'][0])
    {
        $request = $this->getMyCustomerRelationsRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCustomerRelationsAsync(string $contentType = self::contentTypes['getMyCustomerRelations'][0])
    {
        return $this->getMyCustomerRelationsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCustomerRelationsAsyncWithHttpInfo(string $contentType = self::contentTypes['getMyCustomerRelations'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\DomainCustomerRelation[]';
        $request = $this->getMyCustomerRelationsRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMyCustomerRelationsRequest(string $contentType = self::contentTypes['getMyCustomerRelations'][0])
    {
