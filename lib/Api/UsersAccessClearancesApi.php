...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMyAccessClearances'] to see the possible values for this operation
     *
     ...
     */
    public function getMyAccessClearances($domain_uid, string $contentType = self::contentTypes['getMyAccessClearances'][0])
    {
        list($response) = $this->getMyAccessClearancesWithHttpInfo($domain_uid, $contentType);
        return $response;
    }
     ...
     */
    public function getMyAccessClearancesWithHttpInfo($domain_uid, string $contentType = self::contentTypes['getMyAccessClearances'][0])
    {
        $request = $this->getMyAccessClearancesRequest($domain_uid, $contentType);
     ...
     */
    public function getMyAccessClearancesAsync($domain_uid, string $contentType = self::contentTypes['getMyAccessClearances'][0])
    {
        return $this->getMyAccessClearancesAsyncWithHttpInfo($domain_uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyAccessClearancesAsyncWithHttpInfo($domain_uid, string $contentType = self::contentTypes['getMyAccessClearances'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\AccessClearance';
        $request = $this->getMyAccessClearancesRequest($domain_uid, $contentType);
     ...
     */
    public function getMyAccessClearancesRequest($domain_uid, string $contentType = self::contentTypes['getMyAccessClearances'][0])
    {
     ...
     * @param  string $domain_uid domain_uid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getUserAccessClearances'] to see the possible values for this operation
     *
     * @throws \Jalismrs\Stalactite\Client\Data\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jalismrs\Stalactite\Client\Data\Model\AccessClearance|\Jalismrs\Stalactite\Client\Data\Model\ApiError
     */
    public function getUserAccessClearances($user_uid, $domain_uid, string $contentType = self::contentTypes['getUserAccessClearances'][0])
    {
        list($response) = $this->getUserAccessClearancesWithHttpInfo($user_uid, $domain_uid, $contentType);
        return $response;
    }
     ...
     * @return array of \Jalismrs\Stalactite\Client\Data\Model\AccessClearance|\Jalismrs\Stalactite\Client\Data\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserAccessClearancesWithHttpInfo($user_uid, $domain_uid, string $contentType = self::contentTypes['getUserAccessClearances'][0])
    {
        $request = $this->getUserAccessClearancesRequest($user_uid, $domain_uid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccessClearancesAsync($user_uid, $domain_uid, string $contentType = self::contentTypes['getUserAccessClearances'][0])
    {
        return $this->getUserAccessClearancesAsyncWithHttpInfo($user_uid, $domain_uid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccessClearancesAsyncWithHttpInfo($user_uid, $domain_uid, string $contentType = self::contentTypes['getUserAccessClearances'][0])
    {
        $returnType = '\Jalismrs\Stalactite\Client\Data\Model\AccessClearance';
        $request = $this->getUserAccessClearancesRequest($user_uid, $domain_uid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserAccessClearancesRequest($user_uid, $domain_uid, string $contentType = self::contentTypes['getUserAccessClearances'][0])
    {
